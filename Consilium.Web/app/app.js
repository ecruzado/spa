...
app.config(function ($routeProvider) {
    ...
    $routeProvider.when("/columna/:nombre/:columnaId", {
        ...
        templateUrl: baseUrl+"app/views/columnaView.html?v=0.1"
    });

    $routeProvider.when("/crearClase/:nombreArea/:area", {
        controller: "crearClaseController",
        templateUrl: baseUrl + "app/views/crearClaseView.html?v=0.1"
    });

    $routeProvider.when("/clase/:claseId", {
        controller: "claseController",
        templateUrl: baseUrl + "app/views/claseView.html?v=0.1"
    });

    $routeProvider.when("/historialClase", {
        controller: "historialClaseController",
        templateUrl: baseUrl + "app/views/historialClaseView.html?v=0.1"
    });

    $routeProvider.when("/usuario", {
        controller: "usuarioController",
        templateUrl: baseUrl + "app/views/usuarioView.html?v=0.1"
    });
    $routeProvider.when("/colegio", {
        controller: "colegioController",
        templateUrl: baseUrl + "app/views/colegioView.html?v=0.1"
    });
    $routeProvider.when("/metodologia", {
        controller: "metodologiaController",
        templateUrl: baseUrl + "app/views/metodologiaView.html?v=0.1"
    });
    $routeProvider.when("/valor", {
        controller: "valorController",
        templateUrl: baseUrl + "app/views/valorView.html?v=0.1"
    });
    $routeProvider.when("/capacidad", {
        controller: "capacidadController",
        templateUrl: baseUrl + "app/views/capacidadView.html?v=0.1"
    });
    $routeProvider.when("/reporte", {
        controller: "reporteController",
        templateUrl: baseUrl + "app/views/reporteView.html?v=0.1"
    });
