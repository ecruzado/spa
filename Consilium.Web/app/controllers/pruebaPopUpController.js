app.controller('pruebaPopUpController', function ($scope, $modalInstance, pruebaDataService, claseCabecera) {
    $scope.user = { userName: "" };
    $scope.lista = [];
    init();

    function init() {
        pruebaDataService.pruebas()
    ...
    $scope.guardarSeleccion = function () {
        var seleccion = $("#jsPrueba").jstree('get_selected');
